...
Email: [
      ...
      },
      {
        ...
        heading:"",
        description: [
          "Unlimited E-mails Monthly For the mentioned contacts"
        ],
        component: true,
  ...
  return (
    <section>
      <div className="container">
        ...
        />
        <div className='container flex items-center justify-center text-4xl text-primery font-medium'>Email Pricing</div>
