    ...
    <div className="max-w-7xl mx-auto p-8 bg-gradient-to-r from-blue-50 to-white rounded-3xl shadow-xl border border-gray-200 mt-6">
      <div className="space-y-10">
        ...
        <p className="text-lg text-gray-700 bg-gray-50 p-5 rounded-lg shadow-md border border-gray-200 leading-relaxed">
          Sending Voice call using ConnexBetter APIs is super easy. You can simply
          pass the voice message in text format, mobile number, countrycode &
          ConnexBetter in the API request to send call instantly.
        </p>

        <DocsAPI
          title="Example Usage:"
          apiCode="https://api.connexbetter.com/request?ConnexBetter=ConnexBetter&mobile=RecepientMobile&country_code=CountryCode&voice=Hello, your OTP is 1234"
        />
        ...
        <div className="space-y-4">
          <DocsAPI
            title="Use Fallback"
            apiCode="https://api.connexbetter.com/request?ConnexBetter=ConnexBetter&mobile=RecepientMobile&country_code=CountryCode&voice=Hello, your OTP is 1234&sender=SENDERID&fb1sms=Hello, your otp is 1234"
        ...
        <div className="space-y-4">
          ...
          <DocsAPI apiCode="https://api.connexbetter.com/request?ConnexBetter=ConnexBetter&mobile=RecepientMobile&country_code=CountryCode&vid=1001&name=Twinkle&otp=1234" />
          <p className="text-lg text-gray-700 bg-gray-50 p-5 rounded-lg shadow-md border border-gray-200 leading-relaxed">
        ...
        <DocsAPI
          title="Events:"
          apiCode="https://api.connexbetter.com/request?ConnexBetter=ConnexBetter&msisdn=RecepientMobile&country_code=COUNTRYCode&eid=EventId"
