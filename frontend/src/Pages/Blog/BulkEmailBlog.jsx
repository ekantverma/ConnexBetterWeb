...
//     },
//     {
//       title: "3. Your Email Should Include Interactive And Commercial Content",
//       description:
...
//             Best Email Marketing Tips to Increase B2B Sales in 2025
//           </h1>
//           <p>
//             Email is not just limited to sending messages to family or employees
//             anymore. While not all of your potential customers use social media
//             or are passionate blog readers, almost everyone uses email every
//             day.
//           </p>
//         </div>
//         <div className=" flex items-center md:justify-end">
//           <img
//             src={BulkEmailblogimg}
//             loading="lazy"
//             alt="image of Email Blog"
//             height={100}
//             width={300}
//           ></img>
//         </div>
...
//             In India, a whopping 122 billion emails are sent every hour, showing
//             that email is still going strong. For digital marketers, email
//             marketing is a key tool. So, businesses need to know how to make the
//             most of it to hit their goals. Using bulk email marketing services
//             is a smart move to reach your customers. Sure, there might be some
//             bumps along the way, but this article will give you some handy tips
//             to nail your marketing targets!
//           </p>
//         </div>
...
//           {/* Closing Note */}
//           <p className="text-gray-700 text-lg">{content[2]}</p>
//         </div>

//         <div className="space-y-8">
//           <h2 className="text-3xl font-bold text-primery mb-6">
//             Tips To Increase B2b Sales With Bulk Email Marketing Services:
//           </h2>
//           {tips.map((step, index) => (
