...
const plans = [
  {
    plan: "Basic",
    planDesc: "Professional email marketing",
    price: "100000 Emails",
    time: "₹0.08 per email",
    button: "View Pricing",
    description: [
      "API Integration across channels",
  ...
  {
    plan: "Starter",
    planDesc: "Advanced email capabilities",
    price: "5,00,000 Emails",
    time: "₹0.06 per email",
    button: "View Pricing",
    description: [
      "All Basic features",
  ...
  },
  {
    ...
    planDesc: "Custom email solutions",
    price: "Custom Pricing",
    time: "Contact for pricing details",
    button: "View Pricing",
    description: [
      "Custom email volume",
    ...
    <section className="bg-[#E9F8F6]">
      ...
      <div className="pt-10 px-4 sm:px-10 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          ${
            plan.plan === "Starter"
              ? "lg:scale-100 rounded-[24px] border-[2px] border-[rgba(42,124,245,0.80)] bg-[#FFF] shadow-[0_0_15px_2px_rgba(0,82,204,0.50)]"
            ...
            >
              ...
              {/* Button ko hamesha bottom pe fix karne ke liye mt-auto */}
              <a href="/Contact" className="mt-auto w-full flex justify-center">
